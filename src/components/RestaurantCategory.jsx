...
const RestaurantCategory = ({ restaurantCategoryInfo }) => {
          ...
          {showItems && (
            <div className="block">
              {category?.card?.card?.itemCards?.map((item) => (
                ...
                >
                  <ul
                    className="border-b border-gray-300 flex w-full p-2 justify-between items-cente"
                    key={item?.card?.info?.id}
                  >
                    ...
                    <div className="flex w-full h-full my-auto max-h-28 max-w-20 md:max-h-28 md:max-w-42 items-center justify-center relative">
                      <img
                        ...
                        alt="Dish Image"
                        className="flex self-center w-full h-full max-h-24 max-w-16 md:max-h-28 ml-auto md:max-w-42 object-cover rounded-xl"
                      />
                    </div>
                  </ul>
                </span>
